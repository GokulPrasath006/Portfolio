...
<body class="main-content">
    <section class="section home" id="home">
        <div class="home-content">
            <div class="left column">
                ...
                <div class="image">
                    <img src="project3/images/hey.jpg" alt="">
                </div>
            </div>
            <div class="right column">
                <h1 class="name">
                    Hi I'm <span class="name-span">Gururam</span> a Student
                </h1>
    ...
    <section class="section portfolio" id="portfolio">
        ...
        <div class="portfolio-content">
            <div class="portfolio-item">
                <div class="image">
                    <img src="project3/images/samp3.jpg" alt="">
                </div>
  ...
  <div class="right column">
                <form action="bujji.php"  method="post" class="contact-form">
    ...
    <footer>
        Created by <a href="">Guru</a> <span class="fa-solid fa-copyright"></span> 2022 All Rights Reserved.!
    </footer>
    <div class="navbar">
        <a href="#home">
